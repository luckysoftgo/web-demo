 ...
 * @author bruce
 */
@Service("mongoStudentDao")
public class MongoStudentDaoImpl extends BaseQueryService<MongoStudent> implements MongoStudentDao{
	
	private Logger logger = LoggerFactory.getLogger(MongoStudentDaoImpl.class.getName());
	...
	public MongoStudent findObjById(Object id) {
		try {
			 ...
			 return (MongoStudent) this.mongoTemplateRead.findById(id, getClassName());
	...
	public MongoStudent findObjByName(String proKey, String proValue) {
		try {
			...
			query.addCriteria(Criteria.where(proKey).is(proValue));
		  	...
		  	return (MongoStudent) this.mongoTemplateRead.findOne(query, getClassName());
	...
	public MongoStudent findObjByProps(Map<String, Object> params) {
		try {
			Query query = buildBaseQuery(params, "eq", null);
		  	...
		  	return (MongoStudent) this.mongoTemplateRead.find(query, getClassName());
