  	...
  	<div class="search_k" align="left">
		<fieldset class="search">
			...
			<div class="search_content">
				...
				用户ID：<input type="text" name="sysUserId" value="${param.sysUserId}" style="height: 20px"/>　
        ...
        <table class="ttab" width="100%" cellspacing="1" onMouseOver="changeto()"  onmouseout="changeback()" >
          ...
          <c:forEach var="loginList" items="${pageView.records}">
	          <tr>
	            ...
	            <td height="20" ><span class="STYLE1">${loginList.sysUserId}</span></td>
	            <td height="20" ><span class="STYLE1">${loginList.sysUserName}</span></td>
