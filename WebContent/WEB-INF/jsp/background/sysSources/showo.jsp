...
<form action="" method="post">
	<input type="hidden" name="id" value="${resources.sourceId}">
		<table class="ttab" height="100" width="70%" border="0" cellpadding="0" cellspacing="1"
			...
			<tr>	
				...
				<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input name="type" type="radio" value="0" <c:if test="${resources.sourceType eq '0'}">checked="checked"</c:if>/>目录　　
						<input name="type" type="radio" value="1" <c:if test="${resources.sourceType eq '1'}">checked="checked"</c:if>/>菜单　　
						<input name="type" type="radio" value="2" <c:if test="${resources.sourceType eq '2'}">checked="checked"</c:if>/>按扭
						</div>
					</td>
				</tr>
				<tr>	
