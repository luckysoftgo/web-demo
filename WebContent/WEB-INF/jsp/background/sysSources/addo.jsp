  ...
  <script type="text/javascript">
	  ...
	  $(function (){
  		$("#name").change(function(){
			...
			if(name != null && name != ''){
				$.ajax({
					url:'<%=request.getContextPath()%>/background/sysSources/findByName.html',
					data:{"name":name},
					type : "POST",
  		...
  		$("#resKey").change(function(){
			...
			if(resKey != null && resKey != ''){
				$.ajax({
					url:'<%=request.getContextPath()%>/background/sysSources/findByKey.html',
					data:{"resKey":resKey},
					type : "POST",
					success:function(msg){
						var obj = eval(msg);
  		...
  		$("#resUrl").change(function(){
			...
			if(resUrl != null && resUrl != ''){
				$.ajax({
					url:'<%=request.getContextPath()%>/background/sysSources/findByUrl.html',
					data:{"resUrl":resUrl},
					type : "POST",
					success:function(msg){
						var obj = eval(msg);
...
<br><br/>
<br/>  
<form action="<%=request.getContextPath()%>/background/sysSources/addOne.html" method="post" name="sourceForm" id="sourceForm" >
		<table class="ttab" height="100" width="70%" border="0" cellpadding="0" cellspacing="1"	align="center">
					    ...
					    <div align="left" class="STYLE1"  style="padding-left:10px;">
                            <select name="parentId">
                                ...
                                <c:forEach var="key" items="${resLists}">
                                    <option value="${key.sourceId}" >${key.sourceName}</option>
                                </c:forEach>
                            </select>
                        </div>
					</td>
			...
			<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" name="sourceName" id="name" />
						</div>
					</td>
				</tr>
				<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" name="sourceKey" id="resKey" />
						</div>
					</td>
				</tr>
				<tr>	
					...
					<td>
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" name="sourceUrl" id="resUrl" />
						</div>
					</td>
				</tr>
				<tr>	
					...
					<td >
					   ...
					   <c:if test="${tag eq 'forSelf'}">
	                    <div align="left" class="STYLE1"  style="padding-left:10px;">
	                        ...
	                        <input name="sourceType" type="radio" value="2"/>按扭
                        </div>
                        </c:if>
				...
				<tr>	
					...
					<td >
						<div align="left" class="STYLE1"  style="padding-left:10px;">
						<input style="height: 20px;width: 200px" name="sourceLevel"/>
						</div>
					</td>
				</tr>
				<tr>	
