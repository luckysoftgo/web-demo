	  ...
	  $(function (){
	  		$("#propsName1").change(function(){
				...
				if(propsName1 != null && propsName1 != ''){
					$.ajax({
						url:'<%=request.getContextPath()%>/background/testStudent/findByName.html',
   ...
   <div class="box">
     <div class="box_border">
       <div class="box_top" ><b class="pl15" >系统管理——>修改信息</b></div>
		...
		<form action="<%=request.getContextPath()%>/background/testStudent/updateById.html" method="post" name="userForm" id="userForm">
			...
			<table class="form_table pt15 pb15 list_table" width="100%" border="1" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="td_left" >
					<input class="input-text lh30" size="40" name="totalMoney" id="totalMoney" value="${object.totalMoney}"></input>
					<font color="red"> <span id="totalMoneyTag" /></font>
					</td>
				</tr>
