	  ...
	  $(function (){
	  		$("#propsName1").change(function(){
				...
				if(propsName1 != null && propsName1 != ''){
					$.ajax({
						url:'<%=request.getContextPath()%>/background/testDemo/findByName.html',
   ...
   <div class="box">
     <div class="box_border">
       ...
       <div class="box_center" style="overflow-y:scroll;align:center; height:75%;">
		<form action="<%=request.getContextPath()%>/background/testDemo/addOne.html" method="post" name="userForm" id="userForm">
