	  ...
	  $(function (){
	  		$("#propsName1").change(function(){
				...
				if(propsName1 != null && propsName1 != ''){
					$.ajax({
						url:'<%=request.getContextPath()%>/background/testScore/findByName.html',
   ...
   <div class="box">
     <div class="box_border">
       <div class="box_top" ><b class="pl15" >系统管理——>修改信息</b></div>
		...
		<form action="<%=request.getContextPath()%>/background/testScore/updateById.html" method="post" name="userForm" id="userForm">

			<input type="hidden" name="score_id" id="score_id" value=""><!-- 修改时候自动添加 -->
			...
			<table class="form_table pt15 pb15 list_table" width="100%" border="1" cellpadding="0" cellspacing="0">
                 <!-- 修改的信息 -->
					...
					<td class="td_left" >
					<input class="input-text lh30" size="40" name="scoreId" id="scoreId" value="${object.scoreId}"></input>
					<font color="red"> <span id="scoreIdTag" /></font>
					</td>
				</tr>
				<tr>
					<td class="td_right">
