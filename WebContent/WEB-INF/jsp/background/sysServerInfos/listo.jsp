...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/fenyecss.css" />
  ...
  <body>
<form id="fenye" name="fenye" action="<%=request.getContextPath()%>/background/sysServerInfos/find.html" method="post">
<table width="100%">
  <tr>
  	...
  	<div class="search_k" align="left">
		<fieldset class="search"　style="border-bottom-color: #FF0099">
			...
			<div class="search_content">
				email：<input type="text" name="email" value="${param.managerEmail}" style="height: 20px"/>　　
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <tr>
            ...
            <td height="20" ><span class="STYLE1">${key.managerEmail}</span></td>
            <td height="20" >
                <span class="STYLE1">
                    <fmt:formatDate value="${key.operatorTime}" pattern="yyyy-MM-dd HH:MM:ss"/>  
                </span>
            </td>
